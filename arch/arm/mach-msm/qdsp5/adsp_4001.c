/* arch/arm/mach-msm/qdsp5/adsp_4001.c
 *
...
static enum qdsp_module_type qdsp_gaudio_task_to_module_table[] = {
	QDSP_MODULE_KERNEL,
	QDSP_MODULE_AFETASK,
	QDSP_MODULE_MAX,
	QDSP_MODULE_MAX,
...
static enum qdsp_module_type qdsp_combo_task_to_module_table[] = {
	QDSP_MODULE_KERNEL,
	QDSP_MODULE_AFETASK,
	QDSP_MODULE_VOCDECTASK,
	QDSP_MODULE_VOCENCTASK,
...
/* Table of modules indexed by task ID for the AUDIO_LP image */
static enum qdsp_module_type qdsp_audio_lp_task_to_module_table[] = {
	QDSP_MODULE_KERNEL,
	QDSP_MODULE_AFETASK,
	QDSP_MODULE_MAX,
	QDSP_MODULE_MAX,
...
/* Queue offset table indexed by queue ID for the AUDIO_LP image */
static uint32_t qdsp_audio_lp_queue_offset_table[] = {
	QDSP_RTOS_NO_QUEUE,  /* QDSP_lpmCommandQueue              */
	...
	QDSP_RTOS_NO_QUEUE,  /* QDSP_rxMpuDecPktQueue             */
	QDSP_RTOS_NO_QUEUE,  /* QDSP_txMpuEncQueue                */
	0x438,               /* QDSP_uPAudPPCmd1Queue             */
	0x43c,               /* QDSP_uPAudPPCmd2Queue             */
	0x440,               /* QDSP_uPAudPPCmd3Queue             */
	0x44c,               /* QDSP_uPAudPlay0BitStreamCtrlQueue */
	QDSP_RTOS_NO_QUEUE,  /* QDSP_uPAudPlay1BitStreamCtrlQueue */
	QDSP_RTOS_NO_QUEUE,  /* QDSP_uPAudPlay2BitStreamCtrlQueue */
	QDSP_RTOS_NO_QUEUE,  /* QDSP_uPAudPlay3BitStreamCtrlQueue */
	QDSP_RTOS_NO_QUEUE,  /* QDSP_uPAudPlay4BitStreamCtrlQueue */
	0x434,               /* QDSP_uPAudPreProcCmdQueue         */
	0x448,               /* QDSP_uPAudRecBitStreamQueue       */
	0x444,               /* QDSP_uPAudRecCmdQueue             */
	QDSP_RTOS_NO_QUEUE,  /* QDSP_uPDiagQueue                  */
	QDSP_RTOS_NO_QUEUE,  /* QDSP_uPJpegActionCmdQueue         */
	QDSP_RTOS_NO_QUEUE,  /* QDSP_uPJpegCfgCmdQueue            */
	QDSP_RTOS_NO_QUEUE,  /* QDSP_uPVocProcQueue               */
...
static enum qdsp_module_type qdsp_qtv_lp_task_to_module_table[] = {
	QDSP_MODULE_KERNEL,
	QDSP_MODULE_AFETASK,
	QDSP_MODULE_MAX,
	QDSP_MODULE_MAX,
...
static enum qdsp_module_type *qdsp_task_to_module[] = {
	qdsp_combo_task_to_module_table,
	qdsp_audio_lp_task_to_module_table,
...
static uint32_t *qdsp_queue_offset_table[] = {
	...
	qdsp_audio_lp_queue_offset_table,
...
static struct adsp_module_info module_info[] = {
	...
	QDSP_MODULE(VIDEOENCTASK, "vdc_clk", 96000000, NULL, NULL),
};
