...
struct msm_mddi_bridge_platform_data {
	...
	/* Jay, Dec 16, 08' 
	 * For same Samsung client with different bridge.
	 */
	/* todo: remove the following */
	void (*adjust)(struct msm_mddi_client_data *); /* for samsung bridge dx */
#define SAMSUNG_D  0
#define SAMSUNG_S6 1 
	int bridge_type;
	int panel_type;
...
/* Jay, for USB Projector to quick access the frame buffer info (Jan 7, 09') */
struct msm_fb_info {
