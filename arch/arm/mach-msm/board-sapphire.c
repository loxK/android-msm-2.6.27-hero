...
static struct msm_camera_device_platform_data sapphire_camera_data = {
	.sensor_reset	= 108,
	.sensor_pwd	= 85,
...
static struct i2c_board_info i2c_mt9p012 = {
	...
	.platform_data = &sapphire_camera_data,
};
...
//	msm_change_usb_id(0x0bb4, 0x0c03);
	...
	if(system_rev != 0x80 &&
		...
		sapphire_get_skuid() != 0x1E303 && sapphire_get_skuid() != 0x1FF01)
