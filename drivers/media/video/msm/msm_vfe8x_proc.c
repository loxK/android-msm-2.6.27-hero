...
* Author: Yannuo     Yang  <yannuoy@qualcomm.com>
...
static void vfe_prog_reg_val(uint8_t *hwreg, uint32_t val)
{
	/* unsigned long flags; */
	uint32_t *ptr;
...
static uint32_t vfe_read_reg_value(uint8_t *reg)
{
	/* unsigned long flags; */
	uint32_t *ptr;
...
{
	vpath->yPath.hwRegPingAddress = (uint8_t *)VFE_BUS_VIEW_Y_WR_PING_ADDR;
	vpath->yPath.hwRegPongAddress = (uint8_t *)VFE_BUS_VIEW_Y_WR_PONG_ADDR;
	...
	epath->yPath.hwRegPingAddress = (uint8_t *)VFE_BUS_ENC_Y_WR_PING_ADDR;
	epath->yPath.hwRegPongAddress = (uint8_t *)VFE_BUS_ENC_Y_WR_PONG_ADDR;
	...
	struct vfe_output_path_combo *out2, uint16_t out)
{
	...
	vfe_prog_hw((uint8_t *)VFE_BUS_ENC_Y_WR_PING_ADDR,
...
static void vfe_reg_bus_cfg(struct vfe_bus_cfg_data *in)
{
	...
	/*  program vfe_bus_cfg */
	vfe_prog_reg_val((uint8_t *)VFE_BUS_CFG, *((uint32_t *)&cmd));
}
...
static void vfe_reg_camif_config(struct vfe_camif_cfg_data *in)
{
	...
	vfe_prog_reg_val((uint8_t *)CAMIF_CONFIG, *((uint32_t *)&cfg));
}
...
static void vfe_reg_bus_cmd(struct vfe_bus_cmd_data *in)
{
	...
	vfe_prog_reg_val((uint8_t *)VFE_BUS_CMD, *((uint32_t *)&cmd));
...
static void vfe_reg_module_cfg(struct vfe_module_enable *in)
{
	...
	vfe_prog_reg_val((uint8_t *)VFE_MODULE_CFG, *((uint32_t *)&ena));
}
...
static void vfe_program_dmi_cfg(enum VFE_DMI_RAM_SEL bankSel)
{
	...
	vfe_prog_reg_val((uint8_t *)VFE_DMI_CFG, value);
	vfe_prog_reg_val((uint8_t *)VFE_DMI_ADDR, 0);
}
	...
	struct vfe_cmd_roll_off_config *in)
{
	...
	for (i = 0; i < VFE_ROLL_OFF_INIT_TABLE_SIZE; i++) {
		...
		vfe_prog_reg_val((uint8_t *)VFE_DMI_DATA_LO, data);
	...
	vfe_prog_reg_val((uint8_t *)VFE_DMI_ADDR,
		LENS_ROLL_OFF_DELTA_TABLE_OFFSET);
	...
	vfe_prog_reg_val((uint8_t *)VFE_DMI_CFG, VFE_DMI_CFG_DEFAULT);
}

static void vfe_set_default_reg_values(void)
{
	vfe_prog_reg_val((uint8_t *)VFE_DEMUX_GAIN_0, 0x800080);
	vfe_prog_reg_val((uint8_t *)VFE_DEMUX_GAIN_1, 0x800080);
	vfe_prog_reg_val((uint8_t *)VFE_CGC_OVERRIDE, 0xFFFFF);

	/* default frame drop period and pattern */
	vfe_prog_reg_val((uint8_t *)VFE_FRAMEDROP_ENC_Y_CFG       , 0x1f);
	vfe_prog_reg_val((uint8_t *)VFE_FRAMEDROP_ENC_CBCR_CFG    , 0x1f);
	vfe_prog_reg_val((uint8_t *)VFE_FRAMEDROP_ENC_Y_PATTERN   , 0xFFFFFFFF);
	vfe_prog_reg_val((uint8_t *)VFE_FRAMEDROP_ENC_CBCR_PATTERN, 0xFFFFFFFF);
	vfe_prog_reg_val((uint8_t *)VFE_FRAMEDROP_VIEW_Y_CFG      , 0x1f);
	vfe_prog_reg_val((uint8_t *)VFE_FRAMEDROP_VIEW_CBCR_CFG   , 0x1f);
	vfe_prog_reg_val((uint8_t *)VFE_FRAMEDROP_VIEW_Y_PATTERN, 0xFFFFFFFF);
	vfe_prog_reg_val((uint8_t *)VFE_FRAMEDROP_VIEW_CBCR_PATTERN,
		0xFFFFFFFF);
	vfe_prog_reg_val((uint8_t *)VFE_CLAMP_MIN_CFG, 0);
	vfe_prog_reg_val((uint8_t *)VFE_CLAMP_MAX_CFG, 0xFFFFFF);
}

static void vfe_config_demux(uint32_t period, uint32_t even, uint32_t odd)
{
	vfe_prog_reg_val((uint8_t *)VFE_DEMUX_CFG, period);
	vfe_prog_reg_val((uint8_t *)VFE_DEMUX_EVEN_CFG, even);
	vfe_prog_reg_val((uint8_t *)VFE_DEMUX_ODD_CFG , odd);
}

static void vfe_pm_stop(void)
{
	vfe_prog_reg_val((uint8_t *)VFE_BUS_PM_CMD,
		VFE_PERFORMANCE_MONITOR_STOP);
}

static void vfe_program_bus_rd_irq_en(uint32_t value)
{
	vfe_prog_reg_val((uint8_t *)VFE_BUS_PINGPONG_IRQ_EN, value);
}

static void vfe_camif_go(void)
{
	vfe_prog_reg_val((uint8_t *)CAMIF_COMMAND, CAMIF_COMMAND_START);
}

static void vfe_camif_stop_immediately(void)
{
	vfe_prog_reg_val((uint8_t *)CAMIF_COMMAND,
		CAMIF_COMMAND_STOP_IMMEDIATELY);
	vfe_prog_reg_val((uint8_t *)VFE_CGC_OVERRIDE, 0);
}

static void vfe_program_reg_update_cmd(uint32_t value)
{
	vfe_prog_reg_val((uint8_t *)VFE_REG_UPDATE_CMD, value);
}

static void vfe_program_bus_cmd(uint32_t value)
{
	vfe_prog_reg_val((uint8_t *)VFE_BUS_CMD, value);
}

static void vfe_program_global_reset_cmd(uint32_t value)
{
	vfe_prog_reg_val((uint8_t *)VFE_GLOBAL_RESET_CMD, value);
}

static void vfe_program_axi_cmd(uint32_t value)
{
	vfe_prog_reg_val((uint8_t *)VFE_AXI_CMD, value);
}

static void vfe_program_irq_composite_mask(uint32_t value)
{
	vfe_prog_reg_val((uint8_t *)VFE_IRQ_COMPOSITE_MASK, value);
}

static void inline vfe_program_irq_mask(uint32_t value)
{
	vfe_prog_reg_val((uint8_t *)VFE_IRQ_MASK, value);
}

static void vfe_program_chroma_upsample_cfg(uint32_t value)
{
	vfe_prog_reg_val((uint8_t *)VFE_CHROMA_UPSAMPLE_CFG, value);
}

static uint32_t vfe_read_axi_status(void)
{
	return vfe_read_reg_value((uint8_t *)VFE_AXI_STATUS);
}

static uint32_t vfe_read_pm_status_in_raw_capture(void)
{
	return vfe_read_reg_value((uint8_t *)VFE_BUS_ENC_CBCR_WR_PM_STATS_1);
}
...
{
	afControl->hwRegPingAddress = (uint8_t *)VFE_BUS_STATS_AF_WR_PING_ADDR;
	afControl->hwRegPongAddress = (uint8_t *)VFE_BUS_STATS_AF_WR_PONG_ADDR;

	awbControl->hwRegPingAddress =
		(uint8_t *)VFE_BUS_STATS_AWB_WR_PING_ADDR;
	awbControl->hwRegPongAddress =
		(uint8_t *)VFE_BUS_STATS_AWB_WR_PONG_ADDR;
}

static uint32_t vfe_read_camif_status(void)
{
	return vfe_read_reg_value((uint8_t *)CAMIF_STATUS);
}
...
static void vfe_program_lut_bank_sel(struct vfe_gamma_lut_sel *in)
{
	...
	vfe_prog_hw((uint8_t *)VFE_LUT_BANK_SEL, (uint32_t *)&cmd, sizeof(cmd));
}
...
static void vfe_program_stats_cmd(struct vfe_stats_cmd_data *in)
{
	...
	vfe_prog_reg_val((uint8_t *)VFE_STATS_CMD, *((uint32_t *)&stats));
}
...
static void vfe_pm_start(struct vfe_cmd_bus_pm_start *in)
{
	...
	vfe_prog_hw((uint8_t *)VFE_BUS_PM_CFG,
		(uint32_t *)&cmd, sizeof(cmd));
}
...
static int vfe_get_af_pingpong_status(void)
{
	...
	busPingPongStatus =
		vfe_read_reg_value((uint8_t *)VFE_BUS_PINGPONG_STATUS);
...
{
	if (pipo == FALSE)
		return vfe_read_reg_value(
			(uint8_t *)VFE_BUS_STATS_AF_WR_PING_ADDR);
	else
		return vfe_read_reg_value(
			(uint8_t *)VFE_BUS_STATS_AF_WR_PONG_ADDR);
}
...
{
	if (pipo == FALSE)
		vfe_prog_reg_val((uint8_t *)VFE_BUS_STATS_AF_WR_PING_ADDR,
			addr);
	else
		vfe_prog_reg_val((uint8_t *)VFE_BUS_STATS_AF_WR_PONG_ADDR,
			addr);
}
...
vfe_read_awb_buf_addr(boolean pingpong)
{
	if (pingpong == FALSE)
	 ...
	 return vfe_read_reg_value((uint8_t *)VFE_BUS_STATS_AWB_WR_PONG_ADDR);
}

static void vfe_update_awb_buf_addr(
	boolean pingpong, uint32_t address)
{
	if (pingpong == FALSE)
		vfe_prog_reg_val((uint8_t *)VFE_BUS_STATS_AWB_WR_PING_ADDR,
			address);
	else
		vfe_prog_reg_val((uint8_t *)VFE_BUS_STATS_AWB_WR_PONG_ADDR,
			address);
}
	...
	boolean bank, int16_t *pTable)
{
	...
	for (i = 0; i < VFE_GAMMA_TABLE_LENGTH; i++) {
		vfe_prog_reg_val((uint8_t *)VFE_DMI_DATA_LO,
			(uint32_t)(*pTable));
		pTable++;
	}
...
{
	vfe_prog_reg_val((uint8_t *)VFE_HW_TESTGEN_CMD, value);
}

static void __inline vfe_read_irq_status(struct vfe_irq_thread_msg *out)
{
	uint32_t *temp;

	memset(out, 0, sizeof(struct vfe_irq_thread_msg));

	temp = (uint32_t *)VFE_IRQ_STATUS;
	out->vfeIrqStatus = *temp;

	temp = (uint32_t *)CAMIF_STATUS;
	out->camifStatus = *temp;
	vfe_prog_reg_val((uint8_t *)CAMIF_COMMAND, 0x7);
	vfe_prog_reg_val((uint8_t *)CAMIF_COMMAND, 0x3);
	CDBG("camifStatus  = 0x%x\n", out->camifStatus);

/*
	temp = (uint32_t *)VFE_DEMOSAIC_STATUS;
	out->demosaicStatus = *temp;

	temp = (uint32_t *)VFE_ASF_MAX_EDGE;
	out->asfMaxEdge = *temp;

	temp = (uint32_t *)VFE_BUS_ENC_Y_WR_PM_STATS_0;
*/

#if 0
	out->pmInfo.encPathPmInfo.yWrPmStats0      = *temp++;
	out->pmInfo.encPathPmInfo.yWrPmStats1      = *temp++;
	out->pmInfo.encPathPmInfo.cbcrWrPmStats0   = *temp++;
	out->pmInfo.encPathPmInfo.cbcrWrPmStats1   = *temp++;
	out->pmInfo.viewPathPmInfo.yWrPmStats0     = *temp++;
	out->pmInfo.viewPathPmInfo.yWrPmStats1     = *temp++;
	out->pmInfo.viewPathPmInfo.cbcrWrPmStats0  = *temp++;
	out->pmInfo.viewPathPmInfo.cbcrWrPmStats1  = *temp;
#endif /* if 0 Jeff */
}
	...
	uint8_t fragmentCount)
{
	...
	if (in->hwCurrentFlag == ping) {
		...
		vfe_prog_reg_val(in->hwRegPingAddress, (nextFragmentAddr));
		in->hwCurrentFlag = pong;

	} else {

		vfe_prog_reg_val(in->hwRegPongAddress, (nextFragmentAddr));
	...
	uint32_t *pdestRenderAddr)
{
	...
	busPingPongStatus = vfe_read_reg_value(
		(uint8_t *)VFE_BUS_PINGPONG_STATUS);
	...
	if (busPingPongStatus == 0) {
		...
		/* read out y address. */
		tempAddress = vfe_read_reg_value(in->yPath.hwRegPongAddress);
		CDBG("pong 1 addr = 0x%x\n", tempAddress);
		*pdestRenderAddr++ = tempAddress;
		/* read out cbcr address. */
		tempAddress = vfe_read_reg_value(in->cbcrPath.hwRegPongAddress);
		CDBG("pong 2 addr = 0x%x\n", tempAddress);
		*pdestRenderAddr = tempAddress;

		/* b. update pong address */
		vfe_prog_reg_val(in->yPath.hwRegPongAddress, *pNextAddr++);
		vfe_prog_reg_val(in->cbcrPath.hwRegPongAddress, *pNextAddr);
	} else {
		/* hw is working on pong, render ping buffer */

		/* a. read out ping address */
		tempAddress = vfe_read_reg_value(in->yPath.hwRegPingAddress);
		CDBG("ping 1 addr = 0x%x\n", tempAddress);
		*pdestRenderAddr++ = tempAddress;
		tempAddress = vfe_read_reg_value(in->cbcrPath.hwRegPingAddress);
		CDBG("ping 2 addr = 0x%x\n", tempAddress);
		*pdestRenderAddr = tempAddress;

		/* b. update ping address */
		vfe_prog_reg_val(in->yPath.hwRegPingAddress, *pNextAddr++);
		CDBG("NextAddress = 0x%x\n", *pNextAddr);
		vfe_prog_reg_val(in->cbcrPath.hwRegPingAddress, *pNextAddr);
	}
}
...
#if 0
	if (ctrl->vfeInterruptStatus.afPingpongIrq)
		vfe_process_stats_af_irq();

	if (ctrl->vfeInterruptStatus.awbPingpongIrq)
...
void vfe_parse_irq(void)
{
	...
	vfe_prog_reg_val((uint8_t *)VFE_IRQ_CLEAR, irq.vfeIrqStatus);
}
...
void vfe_stop(void)
{
	...
	vfe_prog_reg_val((uint8_t *)VFE_IRQ_CLEAR, VFE_CLEAR_ALL_IRQS);
...
CDBG("vfe_start operationMode = %d\n", in->operationMode);
	...
	vfe_prog_reg_val((uint8_t *)VFE_CFG, *(uint32_t *)&hwcfg);
	...
	vfe_prog_reg_val((uint8_t *)VFE_CHROMA_UPSAMPLE_CFG,
		*(uint32_t *)&(chromupcfg));

	/* MISR to monitor the axi read. */
	vfe_prog_reg_val((uint8_t *)VFE_BUS_MISR_MAST_CFG_0, 0xd8);
...
vfe_prog_reg_val((uint8_t *)VFE_IRQ_CLEAR, VFE_CLEAR_ALL_IRQS);
	...
	vfe_prog_reg_val((uint8_t *)VFE_REG_UPDATE_CMD,
		VFE_REG_UPDATE_TRIGGER);
	...
	if (ctrl->axiOutputMode == VFE_AXI_OUTPUT_MODE_CAMIFToAXIViaOutput2) {
		...
		while (rawmode) {
			pmstatus = vfe_read_reg_value(
				(uint8_t *)VFE_BUS_ENC_CBCR_WR_PM_STATS_1);

			if ((pmstatus & VFE_PM_BUF_MAX_CNT_MASK) != 0)
				rawmode = FALSE;
		}

		/* data is on the bus, so send async signal.
		FIXME: For RAW snapshot */
		/* vfe_drv_complete_async_sequence(); */
	}
...
void vfe_la_update(struct vfe_cmd_la_config *in)
{
	...
	vfe_prog_reg_val((uint8_t *)VFE_DMI_CFG, VFE_DMI_CFG_DEFAULT);
	vfe_prog_reg_val((uint8_t *)VFE_LA_CFG, ctrl->vfeLaBankSel);
}
...
void vfe_test_gen_start(struct vfe_cmd_test_gen_start *in)
{
	...
	vfe_prog_hw((uint8_t *)VFE_HW_TESTGEN_CFG,
		(uint32_t *) &cmd, sizeof(cmd));
}
...
void vfe_frame_skip_update(struct vfe_cmd_frame_skip_update *in)
{
	...
	vfe_prog_hw((uint8_t *)VFE_FRAMEDROP_VIEW_Y_PATTERN,
		(uint32_t *)&cmd, sizeof(cmd));

	cmd.yPattern    = in->output2Pattern;
	cmd.cbcrPattern = in->output2Pattern;
	vfe_prog_hw((uint8_t *)VFE_FRAMEDROP_ENC_Y_PATTERN,
		(uint32_t *)&cmd, sizeof(cmd));
}
...
void vfe_frame_skip_config(struct vfe_cmd_frame_skip_config *in)
{
	...
	vfe_prog_hw((uint8_t *)VFE_FRAMEDROP_ENC_Y_CFG,
		(uint32_t *)&cmd, sizeof(cmd));
}
...
void vfe_output_clamp_config(struct vfe_cmd_output_clamp_config *in)
{
	...
	vfe_prog_hw((uint8_t *)VFE_CLAMP_MAX_CFG, (uint32_t *)&cmd,
		sizeof(cmd));
}
...
void vfe_camif_frame_update(struct vfe_cmds_camif_frame *in)
{
	...
	vfe_prog_hw((uint8_t *)CAMIF_FRAME_CONFIG, (uint32_t *)&cmd,
		sizeof(cmd));
}
	...
	struct vfe_cmd_color_correction_config *in)
{
	...
	vfe_prog_hw((uint8_t *)VFE_COLOR_CORRECT_COEFF_0,
		(uint32_t *)&cmd, sizeof(cmd));
}
...
struct vfe_demosaic_cfg_t cmd;
	...
	memset(&cmd, 0, sizeof(cmd));
	temp = vfe_read_reg_value((uint8_t *)VFE_DEMOSAIC_CFG);
	...
	vfe_prog_hw((uint8_t *)VFE_DEMOSAIC_CFG, (uint32_t *)&cmd, sizeof(cmd));
	...
	vfe_prog_hw((uint8_t *)VFE_DEMOSAIC_ABF_CFG_0, (uint32_t *)&cmdabf,
		sizeof(cmdabf));
}
...
void vfe_demosaic_bpc_update(struct vfe_cmd_demosaic_bpc_update *in)
{
	...
	vfe_prog_hw((uint8_t *)VFE_DEMOSAIC_BPC_CFG_0, (uint32_t *)&cmdbpc,
		sizeof(cmdbpc));
}
...
void vfe_demosaic_config(struct vfe_cmd_demosaic_config *in)
{
	...
	vfe_prog_hw((uint8_t *)VFE_DEMOSAIC_CFG,
		(uint32_t *)&cmd, sizeof(cmd));
	...
	vfe_prog_hw((uint8_t *)VFE_DEMOSAIC_ABF_CFG_0,
	...
	vfe_prog_hw((uint8_t *)VFE_DEMOSAIC_BPC_CFG_0,
	...
	struct vfe_cmd_demux_channel_gain_config *in)
{
	...
	vfe_prog_hw((uint8_t *)VFE_DEMUX_GAIN_0, (uint32_t *)&cmd, sizeof(cmd));
}
...
void vfe_black_level_update(struct vfe_cmd_black_level_config *in)
{
	...
	vfe_prog_hw((uint8_t *)VFE_BLACK_EVEN_EVEN_VALUE,
		(uint32_t *)&cmd, sizeof(cmd));
}
...
void vfe_asf_update(struct vfe_cmd_asf_update *in)
{
	...
	vfe_prog_hw((uint8_t *)VFE_ASF_CFG, (uint32_t *)&cmd, sizeof(cmd));
}
...
void vfe_asf_config(struct vfe_cmd_asf_config *in)
{
	...
	vfe_prog_hw((uint8_t *)VFE_ASF_CROP_WIDTH_CFG, (uint32_t *)&cmd2,
		sizeof(cmd2));
}
...
void vfe_white_balance_config(struct vfe_cmd_white_balance_config *in)
{
	...
	vfe_prog_hw((uint8_t *)VFE_WB_CFG, (uint32_t *)&cmd, sizeof(cmd));
}
...
void vfe_chroma_sup_config(struct vfe_cmd_chroma_suppression_config *in)
{
	...
	vfe_prog_hw((uint8_t *)VFE_CHROMA_SUPPRESS_CFG_0, (uint32_t *)&cmd,
		sizeof(cmd));
}
...
void vfe_roll_off_config(struct vfe_cmd_roll_off_config *in)
{
	...
	vfe_prog_hw((uint8_t *)VFE_ROLLOFF_CFG_0, (uint32_t *)&cmd,
		sizeof(cmd));
	...
	struct vfe_cmd_chroma_subsample_config *in)
{
	...
	vfe_prog_hw((uint8_t *)VFE_CHROMA_SUBSAMPLE_CFG, (uint32_t *)&cmd,
		sizeof(cmd));
}
...
void vfe_chroma_enhan_config(struct vfe_cmd_chroma_enhan_config *in)
{
	...
	vfe_prog_hw((uint8_t *)VFE_CHROMA_ENHAN_A, (uint32_t *)&cmd,
		sizeof(cmd));
	vfe_prog_hw((uint8_t *)VFE_COLOR_CONVERT_COEFF_0, (uint32_t *)&cmd2,
		sizeof(cmd2));
}
...
void vfe_scaler2cbcr_config(struct vfe_cmd_scaler2_config *in)
{
	...
	vfe_prog_hw((uint8_t *)VFE_SCALE_CBCR_CFG, (uint32_t *)&cmd,
		sizeof(cmd));
}
...
void vfe_scaler2y_config(struct vfe_cmd_scaler2_config *in)
{
	...
	vfe_prog_hw((uint8_t *)VFE_SCALE_Y_CFG, (uint32_t *)&cmd, sizeof(cmd));
}
...
void vfe_main_scaler_config(struct vfe_cmd_main_scaler_config *in)
{
	...
	vfe_prog_hw((uint8_t *)VFE_SCALE_CFG,
		(uint32_t *)&cmd, sizeof(cmd));
}
...
void vfe_stats_update_wb_exp(struct vfe_cmd_stats_wb_exp_update *in)
{
	...
	cmd.c3  = in->awbCCFG[2];
	cmd.c4  = in->awbCCFG[3];
	vfe_prog_hw((uint8_t *)VFE_STATS_AWB_MCFG, (uint32_t *)&cmd,
		sizeof(cmd));
	...
	vfe_prog_hw((uint8_t *)VFE_STATS_AWBAE_CFG, (uint32_t *)&cmd2,
		sizeof(cmd2));
}
...
void vfe_stats_update_af(struct vfe_cmd_stats_af_update *in)
{
	...
	vfe_prog_hw((uint8_t *)VFE_STATS_AF_CFG, (uint32_t *)&cmd, sizeof(cmd));
}
...
void vfe_stats_start_wb_exp(struct vfe_cmd_stats_wb_exp_start *in)
{
	...
	vfe_prog_hw((uint8_t *)VFE_STATS_AXW_HEADER, (uint32_t *)&cmd3,
		sizeof(cmd3));
}
...
ctrl->vfeImaskLocal.afPingpongIrq = TRUE;
	...
	vfe_prog_hw((uint8_t *)VFE_STATS_AF_GRID_0, (uint32_t *) &cmd2,
		sizeof(cmd2));
}
...
void vfe_stats_setting(struct vfe_cmd_stats_setting *in)
{
	...
	vfe_prog_hw((uint8_t *)VFE_STATS_FRAME_SIZE, (uint32_t *)&cmd1,
		sizeof(cmd1));
	...
	vfe_prog_hw((uint8_t *)VFE_BUS_STATS_WR_PRIORITY,
	...
	vfe_prog_reg_val((uint8_t *)VFE_BUS_STATS_HIST_WR_PING_ADDR,
		in->histBuffer[0]);

	vfe_prog_reg_val((uint8_t *)VFE_BUS_STATS_HIST_WR_PONG_ADDR,
		in->histBuffer[1]);
}
...
void vfe_axi_input_config(struct vfe_cmd_axi_input_config *in)
{
	...
	/*  program vfe_bus_cfg */
	vfe_prog_hw((uint8_t *)VFE_BUS_STRIPE_RD_ADDR_0,
		(uint32_t *)&cmd, sizeof(cmd));

	/* hacking code, put it to default value */
	busPingpongRdIrqEnable = 0xf;

	vfe_prog_reg_val((uint8_t *)VFE_BUS_PINGPONG_IRQ_EN,
		busPingpongRdIrqEnable);
}
...
void vfe_camif_config(struct vfe_cmd_camif_config *in)
{
	...
	vfe_prog_hw((uint8_t *)CAMIF_EFS_CONFIG, (uint32_t *)&cmd, sizeof(cmd));
}
...
void vfe_fov_crop_config(struct vfe_cmd_fov_crop_config *in)
{
	...
	vfe_prog_hw((uint8_t *)VFE_CROP_WIDTH_CFG,
		(uint32_t *)&cmd, sizeof(cmd));
}
...
void vfe_get_hw_version(struct vfe_cmd_hw_version *out)
{
	...
	vfeHwVersionPacked = vfe_read_reg_value((uint8_t *)VFE_HW_VERSION);
...
void vfe_reset(void)
{
	...
	/* disable all interrupts. */
	vfe_prog_reg_val((uint8_t *)VFE_IRQ_COMPOSITE_MASK,
		VFE_DISABLE_ALL_IRQS);
	/* clear all pending interrupts*/
	vfe_prog_reg_val((uint8_t *)VFE_IRQ_CLEAR, VFE_CLEAR_ALL_IRQS);
	/* enable reset_ack interrupt.  */
	vfe_prog_reg_val((uint8_t *)VFE_IRQ_MASK, ctrl->vfeImaskPacked);
	vfe_prog_reg_val((uint8_t *)VFE_GLOBAL_RESET_CMD,
		VFE_RESET_UPON_RESET_CMD);
}
